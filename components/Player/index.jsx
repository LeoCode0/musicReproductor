...
export const Player = () => {
  ...
  useEffect(() => {
    fetch(
      `https://ws.audioscrobbler.com/2.0/?method=tag.gettoptracks&tag=rock&api_key=6965faf2bd1c9d882e72bc0aef536612&limit=1&format=json`
    )
      .then((data) => data.json())
...
export const Desk = () => {
  ...
  useEffect(() => {
    fetch(
      `https://ws.audioscrobbler.com/2.0/?method=tag.gettoptracks&tag=pop&api_key=6965faf2bd1c9d882e72bc0aef536612&limit=1&format=json`
    )
      .then((data) => data.json())
      .then((json) => setSong(json.tracks.track[0]));
  }, []);
